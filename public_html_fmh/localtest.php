...
<?php /* --------------- START HERE -------------------- */ ?>
  ...
  $(document).ready ( function(){
    ...
    switch(carrierName){
      case "UPS Freight":
        ...
        $.ajax({
          ...
          url: "http://localhost:8000/public_html_fmh/apis/ups.php?id="+carrierTrackingID,
          success: function(data){ 
              ...
              if( typeof data.Shipment.DeliveryDetail.length == 'undefined' ){
                row = data.Shipment.DeliveryDetail;
                if( row.Type.Description == 'Estimated Delivery' ){
                  // estimated date of delivery
                  carrierETD = formatDateTime(row.Date);
                }
              }
              // otherwise we end up in this loop
      ...
      default:        
        ...
        console.log('API carrier not found');
      break;
    }
    ...
    function drawCarrierActivity(){
      ...
      console.log('ETD: ',carrierETD,' - ATD: ',carrierATD);
