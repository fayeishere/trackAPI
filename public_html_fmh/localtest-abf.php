  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      <div class="status_form">
        <form action="" method="get">
          <ul>
            ...
            <li><label>PO # </label><input name="" type="text" value="00847007327038A" class="input_item" /></li>
      ...
      <div class="status_info">
        ...
        <li><span class="title">Carrier:</span> <span id="carrierName">ABF</span></li>
        <li><span class="title">Status: </span> <span id="carrierStatus">checking...</span></li>

        <li><span class="title">Tracking #:</span> <span id="carrierTrackingID">185416849</span></li>
...
<div class="status_info">
  ...
  <!--<li><span class="title">ETA to Agent:       </span><a href="12/02/2014"target="_blank">Track Arrival Date</a></li>-->
    <!--<li><span class="title">Tracking #</label> <input name="" type="href" value="12/02/2014" class="input_item" /></li>-->
          <li><span class="title">ETA to Agent:     </span>12/02/2014</li>
          <li><span class="title">Location: </span>Windsor Locks<span class="title">, </span>CT</li>
          <li><span class="title">Arrived at Agent: </span><span id="arrivedAtAgent">12/02/2014</span></li>
          <li><span class="title">Phone: </span>860-292-8075</li>
          <li><span class="title">Scheduled Date:   </span>12/09/2014</li>
          <li></li>
          <li><span class="title">Completion Date:  </span>12/09/2014</li>
    <li><span class="title"></span></li>
