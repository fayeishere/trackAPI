  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      <div class="status_form">
        <form action="" method="get">
          <ul>
            ...
            <li><label>PO # </label><input name="" type="text" value="00847009653931" class="input_item" /></li>
      ...
      <div class="status_info">
        ...
        <li><span class="title">Carrier:</span> <span id="carrierName">Old Dominion</span></li>
        <li><span class="title">Status: </span> <span id="carrierStatus">checking...</span></li>

        <li><span class="title">Tracking #:</span> <span id="carrierTrackingID">28701727555</span></li>
